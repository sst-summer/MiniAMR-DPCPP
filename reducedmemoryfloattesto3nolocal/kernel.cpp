               ...
               for (int j = 1; j <= 10; j++)
                  for (int k = 1; k <= 10; k++)
                     accessor_out[(var * (12) * (12) * (12)) + (k + (12) * (j + (12) * i))] = (
                        accessor_in[(var * (12) * (12) * (12)) + (k + (12) * (j + (12) * (i - 1)))] +
                        accessor_in[(var * (12) * (12) * (12)) + (k + (12) * ((j-1) + (12) * i))] +
                        accessor_in[(var * (12) * (12) * (12)) + ((k-1) + (12) * (j + (12) * i))] +
                        accessor_in[(var * (12) * (12) * (12)) + (k + (12) * (j + (12) * i))] +
                        accessor_in[(var * (12) * (12) * (12)) + ((k+1) + (12) * (j + (12) * i))] +
                        accessor_in[(var * (12) * (12) * (12)) + (k + (12) * ((j+1) + (12) * i))] +
                        accessor_in[(var * (12) * (12) * (12)) + (k + (12) * (j + (12) * (i + 1)))]) / 7.0;
         }
